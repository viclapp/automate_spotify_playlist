...
#Instanciation de la boite à outil:
tool_box = ToolBox()

#Instanciation du tourne vis:
screw_driver = Screwdriver(5)

#Instanciation du marteau:
hammer = Hammer(color="blue")

tools = (screw_driver, hammer)

for tool in tools:
    tool_box.add_tool(tool)
print(tools)

#Instanciation d'une vis
screw = Screw()
